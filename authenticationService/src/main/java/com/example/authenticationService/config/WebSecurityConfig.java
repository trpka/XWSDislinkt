...
import com.example.authenticationService.security.RestAuthenticationEntryPoint;
import com.example.authenticationService.security.TokenAuthenticationFilter;
import com.example.authenticationService.service.impl.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/companyRequest/**").permitAll()
